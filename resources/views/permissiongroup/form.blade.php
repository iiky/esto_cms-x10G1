@php
    ...
    if(isset($permissiongroup_data)){
        $breadcrumb_parent = Breadcrumbs::generate(Request::route()->getName(), $permissiongroup_data)->where('title', '!=', $breadcrumb->title)->last();
    } else {
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label">Parent Group</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control @error('name') is-invalid @enderror" name="name" type="text" @if(isset($permissiongroup_data) || !is_null(old('name'))) value="@if(isset($permissiongroup_data)){{old('name',$permissiongroup_data->name)}}@else{{old('name')}}@endif" @endif placeholder="Permission Group" required autofocus>
                                            @error('name')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
